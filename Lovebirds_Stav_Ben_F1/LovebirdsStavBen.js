...
(lib.whitbig = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#CCCCCC").ss(1,1,1).p("A97gcMA8VAAAA9rNIMA7vAAAA+ZtHMA8TAAA");
...
(lib.waterC = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#3296C8").ss(1,1,1).p("AAaAEIgVAbAAOgLIgaAVAADgeIgcAS");
	this.shape.setTransform(-27.7,11.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#3296C8").ss(1,1,1).p("AAygQIgVAZAAmghIgbAXAAcgzIgcASAgUgQIgdARAgCAFIgZAZAATAcIgTAY");
	this.shape_1.setTransform(-30.1,13.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#3296C8").ss(1,1,1).p("AAzhFIgcASAA+gzIgbAXAAVgMIgYAYAgaAXIgZAZAgDAuIgVAYAgsABIgdASAArAKIgUAYAACgiIgbASABKgiIgVAa");
	this.shape_2.setTransform(-32.5,15.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#3296C8").ss(1,1,1).p("AAlhAIAagSAAAAAIgZAYAgSgWIgdATAA0gWIgUAaABfg5IgUAbAAogmIgbAXAAWAXIgVAYABXhJIgbAWAABgmIAYgSAgZA7IgUAYAgvAkIgZAZAhCAOIgcAR");
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#3296C8").s().p("");
	this.shape_7.setTransform(-39.8,32.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#3296C8").s().p("");
	this.shape_8.setTransform(-45.5,32.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#3296C8").ss(1.5,1,1).p("");
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#3296C8").ss(1.5,1,1).p("");
	...
	this.shape_14.graphics.f().s("#3296C8").ss(1.5,1,1).p("");
	this.shape_14.setTransform(-40.9,33);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#3296C8").ss(1,1,1).p("AApgEIAAAQAATAVIgFAHAgggbIgIAGAABgaIgEAF");
	...
	this.shape_19.graphics.f("#3296C8").s().p("");
	this.shape_19.setTransform(-46.1,31.6);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#3296C8").ss(1,1,1).p("ABXAZIgEAHABfg+IgPAUAB9ghIgKAPAAvhvIgvAmAA6gPIgEAFAASgmIgKAIAA3hIIgLAKAg6hBIgRANAgbgzIgeAZAhogeIgUAPAhGAoIgdAaAAhARIgPASABEA3IgPAWAAkBoIgIAMAhTgGIgeAYAgBA9IgcAkAAAgWIgrAmAAIh0IgQAN");
	this.shape_20.setTransform(-47.9,36.2);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#3296C8").ss(1,1,1).p("ABqAAIgEAGABNgoIgEAFAAlhAIgKAJAASgvIgNAMAgnhaIgRANAgIhMIgeAYAhVg3IgUAPAgzAPIgdAaAgVgLIgDADAARAkIgJAMABWAeIgOAWAAzgHIgOARAA3BPIgIAMAhAgfIgeAYAALgJIgcAi");
	this.shape_21.setTransform(-49.8,38.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#3296C8").ss(1,1,1).p("AhLhJIgUAPAgpgCIgeAaAgLgdIgEADAAaATIgJALABgAMIgOAWAA9gZIgOASABBA9IgIANAg3gxIgeAZAAVgbIgcAi");
	this.shape_22.setTransform(-50.8,40.5);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#3296C8").ss(1,1,1).p("Ag3gqIgOALABRA2IgJANABNgfIgDAEAgagIIgdAZAhNhCIgDAC");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:22.3,regY:20.5,rotation:-2.6,x:-7.6,y:-6.4},0).wait(1).to({rotation:-5.2},0).wait(1).to({regX:21.9,regY:19.9,rotation:-7.8,x:-7.7,y:-6.5},0).wait(1).to({regX:21.4,regY:20.2,scaleX:1,scaleY:1,rotation:-44.4,x:-7.8,y:-6.4},0).wait(1).to({regX:22.3,regY:20.5,scaleX:1,scaleY:1,rotation:-47,x:-6.9,y:-6.8},0).wait(1).to({rotation:-49.6},0).wait(1).to({rotation:-52.2,y:-6.9},0).wait(1).to({rotation:-54.8,x:-7},0).wait(1).to({rotation:-57.4,y:-7},0).wait(1).to({rotation:-60},0).wait(1).to({regX:22.2,regY:20.4,scaleX:1,scaleY:1,x:-7.8,y:-6.3},0).wait(30).to({regX:20.7,regY:19.6,scaleX:1,scaleY:1,rotation:-57.4,x:-7.7,y:-6.4},0).wait(1).to({regX:22.3,regY:20.5,scaleX:1,scaleY:1,rotation:-55,x:-6,y:-7.2},0).wait(1).to({rotation:-52.5,y:-7.1},0).wait(1).to({rotation:-50},0).wait(1).to({rotation:-47.5,y:-7},0).wait(1).to({rotation:-45,x:-5.9,y:-6.9},0).wait(1).to({rotation:-42.5},0).wait(1).to({rotation:-40,x:-5.8,y:-6.8},0).wait(1).to({rotation:-37.5,y:-6.7},0).wait(1).to({rotation:-35,x:-5.9,y:-6.6},0).wait(1).to({rotation:-32.5,y:-6.5},0).wait(1).to({rotation:-30},0).wait(1).to({rotation:-27.5,x:-5.8,y:-6.4},0).wait(1).to({rotation:-25,x:-5.9,y:-6.3},0).wait(1).to({rotation:-22.5,y:-6.2},0).wait(1).to({rotation:-20},0).wait(1).to({rotation:-17.5,y:-6.1},0).wait(1).to({rotation:-15,y:-6},0).wait(1).to({rotation:-12.5,y:-5.9},0).wait(1).to({rotation:-10,x:-6,y:-5.8},0).wait(1).to({rotation:-7.5},0).wait(1).to({rotation:-5,y:-5.7},0).wait(1).to({rotation:-2.5,y:-5.6},0).wait(1).to({rotation:0,x:-6.1,y:-5.5},0).wait(1).to({regX:25.2,regY:27,scaleX:1,scaleY:1,x:5.5,y:4.6},0).wait(1).to({regX:22.3,regY:20.5,rotation:-2.5,x:2.4,y:-1.7},0).wait(1).to({rotation:-5,x:2.1,y:-1.5},0).wait(1).to({rotation:-7.5,x:1.8,y:-1.4},0).wait(1).to({rotation:-10,x:1.6,y:-1.2},0).wait(1).to({rotation:-12.5,x:1.3,y:-1},0).wait(1).to({rotation:-15,x:1,y:-0.8},0).wait(1).to({rotation:-17.5,x:0.8,y:-0.7},0).wait(1).to({rotation:-20,x:0.6,y:-0.4},0).wait(1).to({rotation:-22.5,x:0.4,y:-0.2},0).wait(1).to({rotation:-25,x:0.2,y:0},0).wait(1).to({rotation:-27.5,x:-0.1,y:0.3},0).wait(1).to({rotation:-30,x:-0.2,y:0.5},0).wait(1).to({rotation:-32.5,x:-0.4,y:0.7},0).wait(1).to({rotation:-35,x:-0.6,y:1},0).wait(1).to({rotation:-37.5,x:-0.8,y:1.3},0).wait(1).to({rotation:-40,x:-0.9,y:1.5},0).wait(1).to({rotation:-42.5,x:-1.1,y:1.8},0).wait(1).to({rotation:-45,y:2.1},0).wait(1).to({rotation:-47.5,x:-1.2,y:2.4},0).wait(1).to({rotation:-50,x:-1.3,y:2.7},0).wait(1).to({rotation:-52.5,x:-1.4,y:3},0).wait(1).to({rotation:-55,x:-1.5,y:3.3},0).wait(1).to({rotation:-57.5,x:-1.6,y:3.5},0).wait(1).to({rotation:-60,x:-1.5,y:3.9},0).wait(1).to({rotation:-56.2,x:-0.7,y:1.7},0).wait(1).to({rotation:-52.5,x:0.1,y:-0.6},0).wait(1).to({rotation:-48.7,x:1,y:-2.8},0).wait(1).to({rotation:-45,x:1.9,y:-4.9},0).wait(1).to({rotation:-47.9,x:1.7,y:-2.6},0).wait(1).to({rotation:-50.9,y:-0.2},0).wait(1).to({rotation:-53.9,x:1.6,y:2.1},0).wait(1).to({rotation:-56.9,x:1.5,y:4.5},0).wait(1).to({rotation:-59.9,x:1.4,y:6.9},0).wait(1).to({rotation:-52.4,x:2.1,y:4.5},0).wait(1).to({rotation:-44.9,x:2.9,y:2.1},0).wait(1).to({rotation:-37.4,x:3.8,y:-0.3},0).wait(1).to({rotation:-29.9,x:4.8,y:-2.5},0).wait(1).to({rotation:-33.7,x:3.3,y:0.1},0).wait(1).to({rotation:-37.4,x:1.8,y:2.8},0).wait(1).to({rotation:-41.1,x:0.3,y:5.3},0).wait(1).to({rotation:-44.8,x:-1.1,y:8},0).wait(1).to({rotation:-48.6,x:-1.3,y:10},0).wait(1).to({rotation:-52.3,x:-1.4,y:11.9},0).wait(1).to({rotation:-56.1,x:-1.5,y:13.9},0).wait(1).to({rotation:-59.9,y:15.9},0).wait(1).to({rotation:-57.5,x:-1.6,y:15.6},0).wait(1).to({rotation:-55.1,x:-1.5,y:15.3},0).wait(1).to({rotation:-52.7,x:-1.4,y:15},0).wait(1).to({rotation:-50.3,x:-1.3,y:14.7},0).wait(1).to({rotation:-47.9,x:-1.2,y:14.5},0).wait(1).to({rotation:-45.5,y:14.1},0).wait(1).to({rotation:-43.1,x:-1,y:13.9},0).wait(1).to({rotation:-40.7,x:-0.9,y:13.6},0).wait(1).to({rotation:-38.3,x:-0.8,y:13.3},0).wait(1).to({rotation:-35.9,x:-0.6,y:13.1},0).wait(1).to({rotation:-33.5,x:-0.5,y:12.8},0).wait(1).to({rotation:-31.1,x:-0.3,y:12.5},0).wait(1).to({rotation:-28.7,x:-0.1,y:12.3},0).wait(1).to({rotation:-26.3,x:0,y:12.1},0).wait(1).to({rotation:-23.9,x:0.2,y:11.8},0).wait(1).to({rotation:-21.6,x:0.4,y:11.6},0).wait(1).to({rotation:-19.2,x:0.6,y:11.5},0).wait(1).to({rotation:-16.8,x:0.8,y:11.3},0).wait(1).to({rotation:-14.4,x:1.1,y:11.1},0).wait(1).to({rotation:-12,x:1.4,y:11},0).wait(1).to({rotation:-9.6,x:1.6,y:10.8},0).wait(1).to({rotation:-7.2,x:1.8,y:10.6},0).wait(1).to({rotation:-4.8,x:2.1,y:10.4},0).wait(1).to({rotation:-2.4,x:2.3,y:10.3},0).wait(1).to({rotation:0,x:2.6,y:10.2},0).wait(1));
	...
	this.frame_0 = function() {
		...
		function nextQuestion() {
			...
			if (myArray[qNum][0][1] == "pic") {
				...
				if (myArray[rndQ][0][0] == "מהו הספורט הלאומי במדינה זו?") {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LovebirdsStavBen_atlas_.png?1550133521657", id:"LovebirdsStavBen_atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1550133522232", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1550133522232", id:"sdk/anwidget.js"},
		{src:"components/ui/src/combobox.js?1550133522232", id:"an.ComboBox"}
	],
	preloads: []
};
