...
lib.ssMetadata = [
		{name:"LovebirdsStavBen_atlas_", frames: [[1593,2708,250,327],[0,0,4529,2706],[501,3080,150,328],[0,3197,150,328],[0,2708,499,487],[1089,2708,250,364],[805,3080,250,188],[2601,2708,200,301],[653,3080,150,317],[152,3197,150,328],[304,3197,150,328],[2097,2962,259,227],[1341,2708,250,353],[1561,3063,150,214],[501,2708,292,370],[1057,3080,250,166],[1309,3074,250,166],[2349,2708,250,248],[2097,2708,250,252],[795,2708,292,370],[700,3399,90,128],[578,3410,120,103],[1845,2708,250,310],[805,3270,150,168],[456,3410,120,107]]}
];
...
}).prototype = getMCSymbolPrototype(lib.Symbol8, new cjs.Rectangle(0,0,54.9,120), null);
...
(lib.mainMenw = function(mode,startPosition,loop) {
	...
	this.text.lineWidth = 146;
	this.text.parent = this;
	this.text.setTransform(2,-19.2,0.92,0.92);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666D97").s("#686977").ss(4,1,1).rr(-53.9,-19.05,107.8,38.1,12);
	this.shape.setTransform(1.8,-5.3,1.171,1.18);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMenw, new cjs.Rectangle(-66.9,-29.8,137.8,54.7), null);
...
(lib.climb_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.climb_1();
	this.instance.parent = this;
...
(lib.kidClimb = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(4,81.7,0.858,0.858,0,0,0,25.7,60.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:25.6,scaleX:0.86,scaleY:0.86,x:5.9,y:81.9},0).wait(1).to({scaleX:0.87,scaleY:0.87,x:7.8,y:82.1},0).wait(1).to({scaleX:0.88,scaleY:0.88,x:9.8,y:82.2},0).wait(1).to({scaleX:0.88,scaleY:0.88,x:11.7,y:82.4},0).wait(1).to({scaleX:0.89,scaleY:0.89,x:13.7,y:82.6},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:15.6,y:82.8},0).wait(1).to({regX:25.7,scaleX:0.9,scaleY:0.9,x:17.6,y:83},0).wait(1).to({regX:25.6,scaleX:0.91,scaleY:0.91,x:19.5,y:83.2},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:21.4,y:83.3},0).wait(1).to({scaleX:0.92,scaleY:0.92,x:23.4,y:83.6},0).wait(1).to({regX:25.7,scaleX:0.93,scaleY:0.93,x:25.4,y:83.7},0).wait(1).to({scaleX:0.93,scaleY:0.93,x:27.3,y:83.9},0).wait(1).to({scaleX:0.94,scaleY:0.94,x:29.2,y:84.1},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:31.2,y:84.3},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:33.2,y:84.4},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:35.1,y:84.7},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:37,y:84.9},0).wait(1).to({scaleX:0.97,scaleY:0.97,x:38.9,y:85},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:40.9,y:85.2},0).wait(1).to({regX:25.6,scaleX:0.98,scaleY:0.98,x:42.8,y:85.4},0).wait(1).to({regX:25.7,scaleX:0.99,scaleY:0.99,x:44.8,y:85.5},0).wait(1).to({regX:25.6,scaleX:0.99,scaleY:0.99,x:46.7,y:85.8},0).wait(1).to({regX:25.7,scaleX:1,scaleY:1,x:48.7,y:85.9},0).wait(1).to({x:50.8,y:80.7},0).wait(1).to({x:52.9,y:75.4},0).wait(1).to({x:55.1,y:70.1},0).wait(1).to({x:57.2,y:64.8},0).wait(1).to({regY:60,x:59.4,y:59.4},0).wait(1).to({x:61.5,y:54.1},0).wait(1).to({x:63.7,y:48.8},0).wait(1).to({x:65.8,y:43.5},0).wait(1).to({x:68,y:38.2},0).wait(1).to({x:70.1,y:32.9},0).wait(1).to({x:72.2,y:27.6},0).wait(1).to({x:74.4,y:22.3},0).wait(1).to({x:76.5,y:17},0).wait(1).to({x:78.7,y:11.7},0).wait(1).to({x:80.8,y:6.4},0).wait(1).to({x:83,y:1.1},0).wait(1).to({x:85.1,y:-4.2},0).wait(1).to({x:87.3,y:-9.5},0).wait(1).to({x:89.4,y:-14.8},0).wait(1).to({x:91.6,y:-20.1},0).wait(1).to({x:90.5,y:-24},0).wait(1).to({x:89.4,y:-27.9},0).wait(1).to({x:88.4,y:-31.8},0).wait(1).to({x:87.3,y:-35.7},0).wait(1).to({x:86.3,y:-39.6},0).wait(1).to({x:85.2,y:-43.5},0).wait(1).to({x:84.2,y:-47.4},0).wait(1).to({x:83.1,y:-51.3},0).wait(1).to({x:82.1,y:-55.2},0).wait(1).to({x:81,y:-59.1},0).wait(1).to({x:80,y:-63},0).wait(1).to({x:78.9,y:-66.9},0).wait(1).to({x:77.8,y:-70.8},0).wait(1).to({x:76.8,y:-74.7},0).wait(1).to({x:75.7,y:-78.6},0).wait(1).to({x:74.7,y:-82.5},0).wait(1).to({x:73.6,y:-86.4},0).wait(1).to({x:72.6,y:-90.3},0).wait(1).to({x:71.5,y:-94.2},0).wait(1).to({x:70.5,y:-98.1},0).wait(1).to({x:69.4,y:-102},0).wait(1).to({x:68.4,y:-105.9},0).wait(1).to({x:70.4,y:-109.5},0).wait(1).to({x:72.4,y:-113.1},0).wait(1).to({x:74.5,y:-116.7},0).wait(1).to({x:76.6,y:-120.4},0).wait(1).to({x:78.6,y:-124},0).wait(1).to({x:80.6,y:-127.6},0).wait(1).to({x:82.7,y:-131.2},0).wait(1).to({x:84.8,y:-134.9},0).wait(1).to({x:86.8,y:-138.5},0).wait(1).to({x:88.9,y:-142.1},0).wait(1).to({x:90.9,y:-145.7},0).wait(1).to({x:93,y:-149.4},0).wait(1).to({x:95,y:-153},0).wait(1).to({x:97.1,y:-156.6},0).wait(1).to({x:99.1,y:-160.2},0).wait(1).to({x:101.2,y:-163.9},0).wait(1).to({x:103.2,y:-167.5},0).wait(1).to({x:105.3,y:-171.1},0).wait(1).to({x:107.3,y:-174.8},0).wait(1).to({x:105.1,y:-178.4},0).wait(1).to({x:102.9,y:-182.1},0).wait(1).to({x:100.8,y:-185.7},0).wait(1).to({x:98.6,y:-189.4},0).wait(1).to({x:96.4,y:-193.1},0).wait(1).to({x:94.2,y:-196.7},0).wait(1).to({x:92.1,y:-200.4},0).wait(1).to({x:89.9,y:-204},0).wait(1).to({x:87.7,y:-207.7},0).wait(1).to({x:85.5,y:-211.4},0).wait(1).to({x:83.4,y:-215},0).wait(1).to({x:81.2,y:-218.7},0).wait(1).to({x:79,y:-222.3},0).wait(1).to({x:76.8,y:-226},0).wait(1).to({x:74.7,y:-229.7},0).wait(1).to({x:72.5,y:-233.3},0).wait(1).to({x:70.3,y:-237},0).wait(1).to({x:68.1,y:-240.6},0).wait(1).to({x:66,y:-244.3},0).wait(1).to({x:68.1,y:-249.3},0).wait(1).to({x:70.2,y:-254.2},0).wait(1).to({x:72.4,y:-259.2},0).wait(1).to({x:74.5,y:-264.2},0).wait(1).to({x:76.6,y:-269.1},0).wait(1).to({x:78.8,y:-274.1},0).wait(1).to({x:80.9,y:-279},0).wait(1).to({x:83.1,y:-284},0).wait(1).to({x:85.2,y:-289},0).wait(1).to({x:87.3,y:-293.9},0).wait(1).to({x:89.5,y:-298.9},0).wait(1).to({x:91.6,y:-303.9},0).wait(1).to({x:93.8,y:-308.8},0).wait(1).to({x:95.9,y:-313.8},0).wait(1).to({x:98,y:-318.8},0).wait(1).to({x:100.2,y:-323.7},0).wait(1).to({x:102.3,y:-328.7},0).wait(1).to({x:104.5,y:-333.7},0).wait(1).to({x:103,y:-340.1},0).wait(1).to({x:101.6,y:-346.5},0).wait(1).to({x:100.2,y:-353},0).wait(1).to({x:98.8,y:-359.4},0).wait(1).to({x:97.4,y:-365.8},0).wait(1).to({x:96,y:-372.3},0).wait(1).to({x:94.6,y:-378.7},0).wait(1).to({x:93.2,y:-385.2},0).wait(1).to({x:91.8,y:-391.6},0).wait(1).to({x:90.4,y:-398},0).wait(1).to({x:89,y:-404.5},0).wait(1).to({x:87.6,y:-410.9},0).wait(1).to({x:86.2,y:-417.4},0).wait(1).to({x:86.6,y:-423.7},0).wait(1).to({x:87,y:-430.1},0).wait(1).to({x:87.4,y:-436.5},0).wait(1).to({x:87.8,y:-442.9},0).wait(1).to({x:88.2,y:-449.2},0).wait(1).to({x:88.5,y:-455.6},0).wait(1).to({x:88.9,y:-462},0).wait(1).to({x:89.3,y:-468.4},0).wait(1).to({x:89.7,y:-474.7},0).wait(1).to({x:90.1,y:-481.1},0).wait(1).to({x:90.5,y:-487.5},0).wait(1).to({x:90.9,y:-493.9},0).wait(1).to({x:91.3,y:-500.2},0).wait(1).to({x:91.7,y:-506.6},0).wait(1).to({x:92.1,y:-513},0).wait(1));

	// Layer_3
	this.instance_1 = new lib.fullPlant();
	this.instance_1.parent = this;
	this.instance_1.setTransform(92.2,-184.2,1.797,1.797,0,0,0,-8.6,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(150));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-18,-512.9,189.6,657.2);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LovebirdsStavBen_atlas_.png?1550008197455", id:"LovebirdsStavBen_atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1550008198036", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1550008198036", id:"sdk/anwidget.js"},
		{src:"components/ui/src/combobox.js?1550008198036", id:"an.ComboBox"}
	],
	preloads: []
};
